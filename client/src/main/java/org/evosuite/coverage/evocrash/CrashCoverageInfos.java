...
public  class CrashCoverageInfos {
    ...
    private double previousFitnessFunction = 0;


    public static CrashCoverageInfos instance = null;

    private CrashCoverageInfos() {}
    ...
    public long getLCDuration() {
        return LCTime - startTime;
    }
    public long getEHDuration() {
        return EHTime - startTime;
    }
    public long getSSDuration() {
        return SSTime - startTime;
    }
    public long getFFDuration() {
        return FFTime - startTime;
    }
    ...
    public void setPreviousFitnessFunction(double ff){this.previousFitnessFunction = ff;}
    public double getPreviousFitnessFunction(){return this.previousFitnessFunction;}
