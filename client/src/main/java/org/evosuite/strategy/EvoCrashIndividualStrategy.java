 ...
 *
 * This file was originally part of EvoSuite <http://www.evosuite.org/>, which was later adapted for use in EvoCrash and is now part of EvoCrash.
 *
 ...
 *
 */
public class EvoCrashIndividualStrategy extends TestGenerationStrategy {

	private static final Logger logger = LoggerFactory.getLogger(EvoCrashIndividualStrategy.class);
...
//		TestGaFactory factory = new TestGaFactory();
...
//			    TestGenerationResultBuilder.getInstance().setGeneticAlgorithm(ga);
	...
	private TestSuiteChromosome bootstrapRandomSuite(FitnessFunction<?> fitness,
		...
		RootFixedSizeTestSuiteChromosomeFactory factory = new RootFixedSizeTestSuiteChromosomeFactory(Properties.RANDOM_TESTS);
