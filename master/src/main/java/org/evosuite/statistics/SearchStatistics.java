...
import org.evosuite.coverage.evocrash.CrashCoverageSuiteFitness;
...
public class SearchStatistics implements Listener<ClientStateInformation>{
	...
	private SearchStatistics() { 
        ...
        sequenceOutputVariableFactories.put(RuntimeVariable.CrashFitnessTimeline.name(), new CrashFitnessSequenceOutputVariableFactory());
        sequenceOutputVariableFactories.put(RuntimeVariable.CrashCoverageTimeline.name(), new CrashCoverageSequenceOutputVariableFactory());
